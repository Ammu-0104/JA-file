...
function JobActiveTab2({ ActivePostingJson }) {
  ...
  const [deleteData, setDeleteData] = useState(ActivePostingJson);

  const handleDelete = (indexToRemove) => {
    setDeleteData(prevData => prevData.filter((_, index) => index !== indexToRemove));
  };
                ...
                <div className="act_contInner">
                  <div className="act_contPart2">
                    <div className="act_contContent">
                      ...
                      <div className="act_activeGap">
                        <img src={item.image} alt="" />
                        <span className="act_catgy1">{item.joblisting}</span>{" "}
                      </div>
                    </div>
