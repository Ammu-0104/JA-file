                ...
                <Card className={`viewParent ${item.colorClass}`}>
                  <div className="active_cardCont activePosting">
                    <div className="viewContParent">
                      ...
                      <div
                        className={`view_contPending ${item.colorClassShort}`}
                      >
                        <img src={item.image13} alt="" />
                        <span
                          className={`view_pending ${item.colorClassShort}`}
                        >
                          {item.status2}
                        </span>
                      </div>
              ...
              <Card className="viewParent">
                <div className="active_cardCont activePosting">
                  <div className="viewContParent">
                    ...
                    <div className={`view_contPending ${item.colorClassShort}`}>
                      <img src={item.image13} alt="" />
                      <span className={`view_pending ${item.colorClassShort}`}>
                        {item.status2}
                      </span>
                    </div>
                  </div>
