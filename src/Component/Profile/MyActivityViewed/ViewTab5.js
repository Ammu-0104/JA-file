...
function ViewTab5({ ViewJson }) {
  const todayData = ViewJson.slice(1, 2);
  const YesterdayData = ViewJson.slice(2, 4);
  const TomorrowData = ViewJson.slice(4, 6);
                ...
                <Card>
                  <div className="active_cardCont activePosting">
                    <div className="viewContParent">
                      ...
                      <div className={`view_contPending ${item.colorClass}`}>
                        <img src={item.image16} alt="" />
                        <span className={`view_pending ${item.colorClass}`}>
                          {item.status5}
                        </span>
                      </div>
                    </div>
              ...
              <Card className="viewParent">
                <div className="active_cardCont activePosting">
                  <div className="viewContParent">
                    ...
                    <div className={`view_contPending ${item.classColorHired}`}>
                      <img src={item.image16} alt="" />
                      <span className={`view_pending ${item.classColorHired}`}>
                        {item.status5}
                      </span>
                    </div>
                  </div>
              ...
              <Card className="viewParent">
                <div className="active_cardCont activePosting">
                  <div className="viewContParent">
                    <div className="act_CardSub view_cardSub">
                      <div className="act_inner view_inner">
                        <p className="act_imgContent viewPercentage viewPercentColor">
                          {item.percentage}{" "}
                        </p>
                        <img className="act_close" src={item.image1} alt="" />
                      </div>
