...
function ViewTab4({ ViewJson }) {
  const todayData = ViewJson.slice(1, 4);
  const TomorrowData = ViewJson.slice(4, 9);
                ...
                <Card className={`viewParent ${item.colorClass}`}>
                  <div className="active_cardCont activePosting">
                    <div className="viewContParent">
                      ...
                      <div
                        className={`view_contPending ${item.classColorInterview}`}
                      >
                        <img src={item.image15} alt="" />
                        <span
                          className={`view_pending ${item.classColorInterview}`}
                        >
                          {item.status4}
                        </span>
                      </div>
