...
import PostDownArrow from '../../../assets/Icons/postDownArrow.svg'
...
import JobListingCard from "./Job List/JobListingCard";
...
const Card = ({ title, subtitle, image, image1 }) => (
  <div className="card card-bg Popctg">
    <div className="card-position">
      <img src={image} className="card-rectangle" alt="Card" />
      <img className="card-images" src={image1} alt=""></img>
    </div>
...
const JobListing = ({ onSearch }) => {
  const todayData = cardsData.slice(0, 13);
  ...
  return (
    <div style={{ backgroundColor: "#FAFAFA" }}>
        ...
        <div className="switch_main">
          <Link to="/main/joblisting">
            <div className="jobLst_home">
              Home
              <img src={ArrowIcon} className="jobArrow" alt="" />
            </div>
          </Link>
      ...
      <div className="cardContainer">
        <h3 className="jobLst_category">Popular category</h3>

        <div className="container">
          {todayData.map((card, index) => (
            <Link to="/main/CategoryList">
              <Card
                className="job_popular"
                key={index}
                title={card.title}
      ...
      <div className="filterContainer">
        ...
        <div className="filterContainer2">
          <div className="filter_sort">
            <h3 className="filterContainertext">Recently posted</h3>
